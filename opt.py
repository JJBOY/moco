...
python ssl_train.py MoCo /data/qinxin/CIFAR10 CIFAR10 -a resnet18 --lr 0.06 -b 512 -ms 4096 --symmetric --projector --predictor --sync_bn  -url tcp://localhost:10001

python ssl_train.py SimSiam /data/qinxin/CIFAR10 CIFAR10 -a resnet18 --lr 0.06 -b 512 -fd 2048 --symmetric --projector --predictor --sync_bn --epochs 800 --wd 5e-4 --knn_k 1 -url tcp://localhost:10002
python ssl_train.py BYOL /data/qinxin/CIFAR10 CIFAR10 -a resnet18 --lr 0.06 -b 512 -fd 2048 --projector --predictor --sync_bn --epochs 800 --wd 5e-4 --knn_k 1 -em 0.99
"""
...
def parse_opt():
    ...
    parser.add_argument('method', choices=['MoCo', 'SimSiam', 'BYOL'], default='MoCo',
    ...
    parser.add_argument('--knn_k', default=200, type=int,
                        metavar='N', help='the neighborhood number of knn (default: 200)')
    parser.add_argument('--knn_t', default=0.1, type=float,
                        help='the soft degree of knn (default: 0.1)')
